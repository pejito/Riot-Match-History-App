...
class MastersLeader extends StatefulWidget {
  @override
  _MastersLeaderState createState() => _MastersLeaderState();
}

class _MastersLeaderState extends State<MastersLeader> {

  late List<HighEloProfile> _players;

  Future<HighEloLeaderboard> _fetchLeaderboard(String auth) async{
    final response = await http.get(Uri.parse('https://na1.api.riotgames.com/tft/league/v1/master/?api_key=' + auth));
    if(response.statusCode == 200){
      print("masters leaderboard status code:" + response.statusCode.toString());
              ...
              child: ListView.separated(
                  ...
                  itemBuilder: (context, index){
                    return Container(
                      ...
                      child: ListTile(
                        leading: Image.asset('assests/masters.png'),
